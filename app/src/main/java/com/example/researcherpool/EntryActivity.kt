...
import com.example.researcherpool.databinding.ActivityEntryBinding
...
class EntryActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val appBarConfiguration = AppBarConfiguration(
            setOf(
                R.id.navigation_MyForm, R.id.navigation_participantr
            )
        )
        ...
        dataStoreViewModel.getUsername().observe(this){
